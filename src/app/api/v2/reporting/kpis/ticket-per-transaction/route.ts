...
import { ticketPerTransactionReportQuerySchema } from "@/modules/reporting/contracts/reporting-kpi-schemas";
...
export async function GET(request: Request) {
  try {
    ...
    return handleApiV2Error(
      request,
      error,
      "خطا در دریافت شاخص تیکت به ازای تراکنش",
      "GET /api/v2/reporting/kpis/ticket-per-transaction"
    );
  }
}
